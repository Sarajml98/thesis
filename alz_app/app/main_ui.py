...
# This is a potentially expensive operation if files are large or numerous.
# We cache it to avoid re-reading from disk on every UI interaction.
@st.cache_data
def load_results_from_disk():
    """Load results from the outputs/ directory."""
    results = {}
    import json
    import csv
